...
import { backendImageUrl } from '../constants'
  ...
  return (
    <div className='p-4 w-52 rounded-md ring-1 flex flex-col justify-between'>
      ...
      <div className='h-56 mb-3 rounded-md shadow-[0px_3px_15px_-5px_rgb(0,0,0)] relative'>
        <img src={backendImageUrl + `/${book.image}`} alt="" className='w-full h-full rounded-md' />
      </div>
        ...
        isAdmin ?
          <div className='flex justify-between'>
            <button
              ...
              className='rounded-md bg-orange-500 px-2 py-1 text-sm font-semibold text-white shadow-sm hover:bg-red-500'>
              Edit
            </button>
            <button
