...
export default function Cart() {
    ...
    useEffect(() => {
        const isFormValid = cardNumber && holderName && cvv && expDate
        setIsPurchaseButtonDisabled(!isFormValid);
    }, [cardNumber, holderName, cvv, expDate]);
                            ...
                            <div className='flex items-center  gap-2 w-full'>
                                ...
                                <div className='flex justify-start items-center w-full'>
                                    ...
                                    <input
                                        ...
                                        className="block w-16  rounded-l-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#503C3C]"
                                    />
                                    <div className='bg-zinc-400 py-1.5'>
                                        <h1 className="text-md font-semibold leading-6 text-gray-900 mx-2">/</h1>
                                    </div>
                                    <input
                                        type="number"
                                        name="expYear"
                                        ...
                                        className="block w-16 rounded-r-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#503C3C]"
                                    />
                                    <h1 className='ml-2'>(MM / YY).</h1>
                                </div>
