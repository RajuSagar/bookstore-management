...
const { addBook, editBook, deleteBook, getById, addAuthor, addLiterature, allBooks, allAuthors, allLiteratures, booksByLocation, booksByLiterature, booksByLiteratureandLocation } = require('../controllers/book.controller');
